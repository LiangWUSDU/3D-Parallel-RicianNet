...
def vols_generator_patch (vol_name, num_data, patch_size, stride_patch, out = 1,num_images=98):
...
def vols_mask_generator_patch (vol_name, num_data, patch_size, stride_patch, out = 1,num_images = 25):

    # 120 = number of patches for one volume
    vol_patch = np.empty([num_data*num_images,96,96,64,4])
    #vol_patch = []
    vol_patch2 = []
    patch_loc = []
    count = 0 # count the batch size for the network
